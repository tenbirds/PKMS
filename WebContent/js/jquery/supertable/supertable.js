...
var superTable = function (tableId, options) {
	/////* Initialize */
	options = options || {};
	this.cssSkin = options.cssSkin || "tbl_type";
	...
	if (this.fixedCols > 0 && this.sDataTable.tBodies[0].rows[cleanRow].cells[this.fixedCols] != undefined) {  
	...
	this.callbackFunc && this.callbackFunc(this.headerRows, rowCount);
};