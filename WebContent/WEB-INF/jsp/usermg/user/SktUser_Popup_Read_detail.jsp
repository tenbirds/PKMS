				...
				<fieldset>
					...
					<div style="margin-left: 5px; height: 460px; float: left; vertical-align: top; border: 1px solid #dcdcdc;">
						<fieldset style="height: 100%;">
							...
							<div class="search">
								<table class="sear_table1" style="width:80%;">
									<tr>
										<th style="width: 50px;">검색</th>
										<td>
											<form:select path="searchCondition" items="${SktUserModel.searchConditionsList}" itemLabel="codeName" itemValue="code" /> 
											<form:input path="searchKeyword" cssClass="inp_w60" onkeypress="if(event.keyCode == 13) { fn_readList('search'); return;}" />
										</td>
									</tr>
								</table>
