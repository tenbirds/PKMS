...
<table class="tbl_type11" style="width: 100%;">
	...
	<tr>
		...
		<td><c:choose>
				...
				<c:otherwise>
					<input type="text" id="bp_user_id" name="bp_user_id" value="${BpModel.bp_user_id}" maxlength="20" class="new_inp inp_w90" onchange="javascript:fn_check_bpuser_id()" onkeyup="javascript:fn_check_bpuser_id()"
	...
	<tr>
		...
		<td>
			<input type="text" id="bp_user_phone1" name="bp_user_phone1" value="${BpModel.bp_user_phone1}" maxlength="4" class="new_inp inp_w20" onkeypress="if (event.keyCode<48|| event.keyCode>57)  event.returnValue=false;" style="IME-MODE:disabled;" />
			<input type="text" id="bp_user_phone2" name="bp_user_phone2" value="${BpModel.bp_user_phone2}" maxlength="4" class="new_inp inp_w20" onkeypress="if (event.keyCode<48|| event.keyCode>57)  event.returnValue=false;" style="IME-MODE:disabled;" />
			<input type="text" id="bp_user_phone3" name="bp_user_phone3" value="${BpModel.bp_user_phone3}" maxlength="4" class="new_inp inp_w20" onkeypress="if (event.keyCode<48|| event.keyCode>57)  event.returnValue=false;" style="IME-MODE:disabled;" />
		</td>
		...
		<td align="right" style="padding: 5px 0px 0px 0px;">
			<c:choose>
				<c:when test="${registerFlag == '수정'}">
					...
					<c:if test="${BpModel.bp_user_id != 'admin'}">
