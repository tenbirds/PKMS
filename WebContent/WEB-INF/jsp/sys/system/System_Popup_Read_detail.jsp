...
<script type="text/javaScript" defer="defer">
	...
	function fn_confirm() {
		if (isSelection()) {
			parent.fn_system_popup_callback(system_key, system_name, gubun);
		} else {
			return;
		}
		fn_popup_close();
	...
	function isSelection() {
		if (system_key != "" && !(typeof system_key == "undefined")) {
			return true;
		}
		alert("시스템을 선택하여 주세요.");
		return false;
	...
	function fn_reload(){
		...
		form.action = "/sys/system/System_Popup_Read_Detail.do";
		form.submit();
	}
