...
<script type="text/javaScript" defer="defer">
	...
	function fn_confirm() {
		if (isSelection()) {
			parent.fn_system_popup_callback(system_key, system_name);
		} else {
			return;
		}
		fn_popup_close();
	...
	function fn_reload(){
		...
		form.action = "/sys/system/System_Popup_Read_All.do";
		form.submit();
	}
		...
		<div style="width: 475px;" id="pop_wrap">
			...
			<div id="pop_content">
				...
				<ul class="main_select" style="width: 450px; margin: 10px 0px 0px 10px; position: absolute;">
					...
					<li><form:radiobuttons onclick="javascript:fn_reload();" path="pkgVerCondition" items="${SysModel.pkgVerConditionList}" itemLabel="codeName" itemValue="code" /></li>
				</ul>
