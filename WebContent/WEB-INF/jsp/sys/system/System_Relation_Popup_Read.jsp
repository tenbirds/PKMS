...
<script type="text/javaScript" defer="defer">
	...
	function fn_popup_close() {
		parent.$('img[name=open_relation_system_popup]').closeDOMWindow();
	}

	function fn_confirm() {
		if (isSelection()) {
			parent.fn_system_relation_popup_callback(system_key, system_name);
		} else {
			return;
		}
		fn_popup_close();
	...
	function fn_init() {
		parent.fn_system_popup_callback2("", "");
		fn_popup_close();
	}
	...
	function fn_reload(){
		...
		form.action = "System_relation_Popup_Read_Detail.do";
		form.submit();
	}
