...
function fn_create() {
	...
	doSubmit4File("QnaModel", "/board/qna/Qna_Ajax_Create.do", "fn_callback_create");
}
function fn_update() {
	...
	doSubmit4File("QnaModel", "/board/qna/Qna_Ajax_Update.do", "fn_callback_update");
}
function fn_delete(){
	if (confirm("삭제하시겠습니까?")) {
...
<body>
	<form:form commandName="QnaModel" method="post" enctype="multipart/form-data" onsubmit="return false;">
				...
				<div class="con_detail">
					...
					<table class="tbl_type11"> 
						...
						<tr>
							...
							<td><form:textarea path="content" rows="15" class="textarea_w95" maxlength="15000"/></td>
						</tr>
					</table>
				</div>
			</div>	
