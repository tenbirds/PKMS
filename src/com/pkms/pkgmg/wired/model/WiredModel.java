package com.pkms.pkgmg.wired.model;
 ...
 * 
 */
public class WiredModel extends AbstractModel {
	...
	private final String[][] dev_yn_list_data = new String[][] { { "Y", "DVT/CVT 검증요청" }, { "N", "CVT 검증요청(개발검증 생략)" }, { "D", "DVT/CVT 동시검증요청" }};
